...
def test_litellm_routing_adds_protocol_details() -> None:
    ...
    assert litellm_model_name("openai/deepseek-v4-flash", "openai") == ("openai/deepseek-v4-flash")
    assert protocol_api_base("https://api.example.com", "openai") == ("https://api.example.com/v1")
    assert protocol_api_base("https://api.anthropic.com", "claude") == ("https://api.anthropic.com")
